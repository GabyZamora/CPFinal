...
require_once('negocio/estveh.php');
...
$Obj_Paginador->Cadena = $Obj_EstadoV->ListarTodos( addslashes( @$_POST['txtBuscar'] ) );
$Obj_Paginador->CantTotalReg = $Obj_EstadoV->CantTotalRegistros( addslashes( @$_POST['txtBuscar']
) );
$Obj_Paginador->FilasPorPagina = 30; 
$Obj_Paginador->NumPagina = @$_GET['np']; 
$Obj_Paginador->EnlaceListar = "mod=estveh&form=li"; 
...
<div class="container">
  <div class="table-wrapper">
    <div class="table-title">
      <div class="form-row">
        <div class="col-md-4">
          <a href="index.php?mod=catar&form=li" class="a-titulo-form"><h2>Estado del Vehículo</h2></a>
          </div>
          <div class="col-md-3">
          ...
          <div class="col-md-5">
            ...
            <i class="material-icons">&#xe879;</i><span>Cerrar</span></button>
              <button type="button" class="btn btn-success" onclick="location.replace('index.php?mod=estveh&form=nu');">
            ...
            <tbody>
              ...
              foreach ( $Obj_Paginador->RegistrosPaginados as $Fila ) {
                ...
                <tr>
                  ...
                  <td><?php echo $Fila['Aceptacion']; ?></td>
                  <td><?php echo $Fila['FinalizacionTaller']; ?></td>
                  <td><?php echo $Fila['estado']; ?></td>
                  <td>
                    <a href="index.php?mod=estveh&form=de&id=<?php echo $Fila['id_estado_del_vehiculo'];?>" class="view" title="Detalles"><i class="material-icons">&#xE417;</i></a>
                    <a href="index.php?mod=estveh&form=ed&id=<?php echo $Fila['id_estado_del_vehiculo'];?>" class="edit"><i class="material-icons" data-toggle="tooltip"
                      title="Editar">&#xE254;</i></a>
                      <a href="#" class="delete" onclick="Eliminar('<?php echo $Fila['id_estado_del_vehiculo']; ?>');"><i class="material-icons" data-toggle="tooltip"
                        title="Eliminar">&#xE872;</i></a>
                      </td>
                    </tr>
                    <?php
...
<script type="text/javascript">
    function Eliminar(paId){
        if(confirm('¿Confirma eliminar este registro?')){
            window.location.replace('index.php?mod=estveh&form=el&id=' + paId);
        }
    }
</script>
