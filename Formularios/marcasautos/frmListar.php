...
$Obj_Paginador->Cadena = $Obj_Marcas_Autos->ListarTodos( addslashes( @$_POST['txtBuscar'] ) );
$Obj_Paginador->CantTotalReg = $Obj_Marcas_Autos->CantTotalRegistros( addslashes( @$_POST['txtBuscar']
) );
...
$Obj_Paginador->EnlaceListar = "mod=marc&form=li"; //Define el enlace al modulo y formulario listar de ese módulo
...
<div class="container">
  <div class="table-wrapper">
    <div class="table-title">
      <div class="form-row">
        <div class="col-md-4">
          <a href="index.php?mod=marc&form=li" class="a-titulo-form"><h2>Gestión de
            <b>Marca de Vehículos</b></h2></a>
          </div>
          <div class="col-md-3">
          ...
          <div class="col-md-5">
            ...
            <i class="material-icons">&#xe879;</i><span>Cerrar</span></button>
              <button type="button" class="btn btn-success" onclick="location.replace('index.php?mod=marc&form=nu');">
            ...
            <tbody>
              ...
              foreach ( $Obj_Paginador->RegistrosPaginados as $Fila ) {
                ...
                <tr>
                  ...
                  <td>
                    <a href="index.php?mod=marc&form=ed&id=<?php echo $Fila['id_marca'];?>" class="edit"><i class="material-icons" data-toggle="tooltip"
                      title="Editar">&#xE254;</i></a>
                      <a href="index.php?mod=marc&form=el&id=" class="delete" onclick="Eliminar('<?php echo $Fila['id_marca_art']; ?>');"><i class="material-icons" data-toggle="tooltip"
                        title="Eliminar">&#xE872;</i></a>
                      </td>
                    </tr>
                    <?php
          ...
          function Eliminar(paId){
            if(confirm('¿Confirma eliminar este registro?')){
              window.location.replace('index.php?mod=marc&form=el&id=' + paId);
            }
          }
          </script>
          <?php
