			...
			<div class="form-row">
 				...
 				<div class="form-group col-md-8">
					<label>Categoria de articulo: </label>					
 					<input type="text" class="form-control" id="txtCateArt" readonly value="<?php echo $Fila['NombreCategoriaArticulos']; ?>">
 				</div>
 				</div>
 				<div class="form-row">
 				<div class="form-group col-md-8">
					<label>Proveedor: </label>					
 					<input type="text" class="form-control" id="txtProveedor" readonly value="<?php echo $Fila['NombreProveedor']; ?>">
 				</div>
 				</div>
 				<div class="form-row">
 				<div class="form-group col-md-8">
					<label>Marca de Articulo: </label>					
 					<input type="text" class="form-control" id="txtMarcArt" readonly value="<?php echo $Fila['NombreMarcaArticulos']; ?>">
 				</div>
 				</div>
				<div class="form-row">
