            ...
            <tbody>
                ...
                <tr>
                  <td>
                      ...
                      <p style="color: #3E4348; text-align: center;"><input type="button" name="index" value="Ir a Inicio" style="background-color: tomato; color: white; font-weight: bold; border-style: none; height: 30px; width: 150px; cursor: pointer;" onClick="location.replace('index.php?mod=menu');"></p>
                  </td>
                </tr>
              </tbody>
            </table>
